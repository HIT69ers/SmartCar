...
//char awake_words[30] = "小军小军"； //使用的唤醒词,可使用接口进行修改。
/******麦克风基础功能参数******/
...
std::string appid="";
char *ASR_RES_PATH = (char*)"/home/ucar/ucar_ws/src/xf_mic_asr_offline/config/msc/res/asr/common.jet";//离线语法识别资源路径，重要，与麦克风及appid绑定
